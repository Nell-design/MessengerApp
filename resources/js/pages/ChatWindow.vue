...
// ✅ Donnée pour le message en cours de saisie
const inputText = ref('')

// ✅ Affichage ou non du sélecteur d'émoji
const showEmojiPicker = ref(false)

// ✅ Quand on sélectionne un emoji
function onSelectEmoji(emoji: any) {
  inputText.value += emoji.i // .i donne l'émoji sous forme de caractère, ex: 😊
}



// ✅ Liste de messages mockés
const messages = [
  { id: 1, fromMe: false, text: "Salut ! Comment ça va ?", time: "12:30", avatar: true },
  { id: 2, fromMe: false, text: "Très bien aussi ! Tu as fini le projet ?", time: "12:33", avatar: true },
  { id: 3, fromMe: true, text: "Ça va bien merci ! Et toi ? 😊", time: "12:32", avatar: false },
  { id: 4, fromMe: true, text: "Oui, je viens de terminer. Je t'envoie ça tout de suite.", time: "12:35", avatar: false },
]
</script>
...
<template>
  <div class="flex-1 flex flex-col bg-white rounded-r-xl shadow h-full">
    ...
    <!-- 🔹 Header avec nom + bouton mobile -->
    <div class="flex items-center justify-between px-6 py-4 border-b">
      <div class="flex items-center gap-3">
        <button v-if="props.onOpenSidebar" class="sm:hidden mr-2 bg-transparent text-white p-2 rounded" @click="props.onOpenSidebar()">
          <!-- Flèche retour -->
          <svg xmlns="http://www.w3.org/2000/svg" width="12" height="24" viewBox="0 0 12 24">
            <path fill="#0d0c0c" fill-rule="evenodd" d="m3.343 12l7.071 7.071L9 20.485l-7.778-7.778a1 1 0 0 1 0-1.414L9 3.515l1.414 1.414z"/>
          </svg>
        </button>
        <div class="w-10 h-10 rounded-full bg-gray-200"></div>
        <div><div class="font-semibold">Marie Dupont</div></div>
      </div>
    ...
    <!-- 🔹 Barre de messagerie + sélecteur d'emoji -->
    <div class="p-4 border-t relative">
      <div class="flex items-center gap-2">
        <!-- Bouton emoji -->
        <button @click="showEmojiPicker = !showEmojiPicker" class="text-2xl"><svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 24 24"><path fill="currentColor" d="M14.36 14.23a3.76 3.76 0 0 1-4.72 0a1 1 0 0 0-1.28 1.54a5.68 5.68 0 0 0 7.28 0a1 1 0 1 0-1.28-1.54M9 11a1 1 0 1 0-1-1a1 1 0 0 0 1 1m6-2a1 1 0 1 0 1 1a1 1 0 0 0-1-1m-3-7a10 10 0 1 0 10 10A10 10 0 0 0 12 2m0 18a8 8 0 1 1 8-8a8 8 0 0 1-8 8"/></svg></button>
      ...
      <!-- Panneau Emoji Picker -->
      <div v-if="showEmojiPicker" class="absolute bottom-16 left-4 z-50">
